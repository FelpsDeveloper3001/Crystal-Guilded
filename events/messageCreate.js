    ...
    async execute(message, client) {
        ...
        try {
            ...
            if (message.mentions && message.mentions.users) {
                ...
                if (!afkUsers || !Array.isArray(afkUsers)) return; // Verifica se afkUsers é válido

                let embed = new Embed().setTitle('⚠️ A pessoa que você está mencionando está atualmente AFK');
            ...
            if (!message.content.startsWith(prefix)) {
                ...
                if (!callerList || !Array.isArray(callerList)) return; // Verifica se callerList é válido
